function createHighScoreService(config) {
  ...
  function qualifies(entry, highScores) {
    if (entry.score <= 0) {
      return false;
    }
...
if (typeof module === "object" && module.exports) {
  module.exports = { createHighScoreService };
} else if (typeof globalThis !== "undefined") {
  globalThis.ColumnsHighScores = { createHighScoreService };
}
